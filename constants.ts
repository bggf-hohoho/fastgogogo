import { Category, Language, SoundStyle } from './types';

export const LOCALIZATION: Record<string, Record<Language, string>> = {
  // General
  app_name: { 'zh-TW': '懶人語音記帳', 'en': 'LazyLedger' },
  home_today: { 'zh-TW': '總資產概覽', 'en': "Total Balance" }, // Changed to sound more premium
...
export const SOUND_STYLES: Record<SoundStyle, Record<Language, string>> = {
...
// New: Category Colors for UI Polish
